...
CREATE TABLE `appointment` (
 `Apt#` int(10) NOT NULL AUTO_INCREMENT,
 `P_Id` varchar(255) NOT NULL,
 `date` varchar(255) NOT NULL,
 `time` varchar(255) NOT NULL,
 PRIMARY KEY (`Apt#`),
 KEY `p_key` (`P_Id`),
 CONSTRAINT `p_key` FOREIGN KEY (`P_Id`) REFERENCES `users` (`id`)
...
INSERT INTO `doctor` (`d_id`, `password`, `first_name`, `last_name`, `email`, `address`, `phone`) VALUES
(201, '1234', 'Ansh', 'Stranger', 'abc@gmail.com', '3125  12th Street, Calgary', '8990299812'),
(202, '1234', 'SHAHID AFRIDI', 'ZIHAD', 'gmhs13@yopmail.com', '3125  12th', '7865641399');
...
INSERT INTO `administrator` (`a_id`, `username`, `email`, `password`, `f_name`, `l_name`, `address`, `ph_no`) VALUES ('1001', 'mo', 'mo@gmail.com', '1234', 'mo', 'Yadav', '12st', '45858329');
